  ...
  return (
    <header className="flex items-center justify-between h-24 lg:relative sticky top-0 bg-gray-950">
      ...
      <button onClick={() => setIsNavActive(!isNavActive)} className="lg:hidden z-50">
        <div className="relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] transform transition-all bg-gray-900 ring-0 duration-200 shadow-md">
